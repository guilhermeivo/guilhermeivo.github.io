...
caption <- paste0("Tempo de execução dos cálculos para geração da matriz projectionView no NodeJs ", version)
...
writeLines(paste(
"Javascript ", round(comparison, 0), "\\ignorespaces", sep=""), fileConn)
close(fileConn)
